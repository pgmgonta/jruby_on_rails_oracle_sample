...
ActiveRecord::Schema.define(:version => 20130211080158) do
  ...
  add_foreign_key "emp", "dept", :column => "deptno", :primary_key => nil, :name => "sys_c006991"
  add_foreign_key "emp", "emp", :column => "mgr", :primary_key => nil, :name => "sys_c006990"
